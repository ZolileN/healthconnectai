      ...
      return {
        issuer: {
          metadata: {
            ...
            authorization_endpoint: 'https://dev-auth.example.com/auth',
            token_endpoint: 'https://dev-auth.example.com/token',
            userinfo_endpoint: 'https://dev-auth.example.com/userinfo',
            jwks_uri: 'https://dev-auth.example.com/jwks',
...
if (process.env.NODE_ENV === 'development') {
  ...
  return; // Skip production setup in development
}
